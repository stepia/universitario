...
public class EmployeeDaoHibernate implements EmployeeDao {
    ...
    public List<Employee> getEmployees(String sortBy, boolean sortOrder) {
        if (sortOrder) {
            return sessionFactory.getCurrentSession().createCriteria(Employee.class).addOrder(Order.asc(sortBy))
                        .list();
        } else {
            return sessionFactory.getCurrentSession().createCriteria(Employee.class).addOrder(Order.desc(sortBy))
                        .list();
        }
