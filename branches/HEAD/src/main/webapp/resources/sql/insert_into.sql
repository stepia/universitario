...
INSERT INTO person (id,lastnameua,firstnameua,middlenameua,lastnameru,firstnameru,middlenameru,lastnameeng,firstnameeng,dob,details) VALUES (114,'СоколОлександренко','Ольга','Леонідівна','СоколОлександренко','Ольга','Леонидовна','SokolOleksandrenko','Olga','1964-09-02','кандидат юридичних наук, доцент'); 
